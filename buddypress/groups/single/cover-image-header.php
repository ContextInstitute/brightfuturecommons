...
<div id="cover-image-container"><!-- bfc-marker cover-image-header.php -->
	...
	<div id="header-cover-image" class="cover-<?php echo $group_cover_height; ?> <?php echo 'width-' . $group_cover_width; ?> <?php echo $has_cover_image_position; echo $has_cover_image; ?>" >
		<?php

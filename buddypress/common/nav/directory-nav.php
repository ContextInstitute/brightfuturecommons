...
<nav class="<?php bp_nouveau_directory_type_navs_class(); ?> bp-subnavs" role="navigation" aria-label="<?php esc_attr_e( 'Directory menu', 'bfcommons-theme' ); ?>">
	...
	<?php if ( bp_nouveau_has_nav( array( 'object' => 'directory' ) ) ) : ?>
		...
		<ul class="component-navigation <?php bp_nouveau_directory_list_class(); ?>">
			...
			<?php endwhile; ?>
			<li class="bp-members-filter-wrap bfc-members-filter subnav-filters filters no-ajax">

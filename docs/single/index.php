	...
	<?php if ( bp_docs_is_doc_edit_locked() && current_user_can( 'bp_docs_edit' ) ) : ?>
		<div class="toggleable doc-is-locked">
			...
			<div class="toggle-content">
				...
				<?php if (  bp_is_active( 'groups' ) && bp_is_group() && bp_group_is_admin()  ) : ?>
					<p><?php printf( __( 'Please try again in a few minutes. Or, as a steward, you can <a href="%s">force cancel</a> the edit lock.', 'buddypress-docs' ), bp_docs_get_force_cancel_edit_lock_link() ) ?></p>
				<?php elseif (is_super_admin()) : ?>
					<p><?php printf( __( 'Please try again in a few minutes. Or, as a site-admin, you can <a href="%s">force cancel</a> the edit lock.', 'buddypress-docs' ), bp_docs_get_force_cancel_edit_lock_link() ) ?></p>
				<?php else : ?>

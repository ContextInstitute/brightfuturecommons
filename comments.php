...
<div id="comments" class="comments-area">
	...
	<!-- .comments-title -->
	<h4 class="comments-title"><?php esc_html_e( 'Responses', 'bfcommons-theme' ); ?></h4>
	...
	$args = array(
		 ...
		 * %3$s - User Name
         */
		'logged_in_as'       => '<p class="logged-in-as">' . sprintf( __( '<a class="comment-author" href="%1$s"><span class="vcard">%2$s</span><span class="name">%3$s</span></a>', 'bfcommons-theme' ), $user_link, get_avatar( get_current_user_id(), 80 ), $user_identity ) . '</p>',
		'class_submit'       => 'submit button outline small',
		'title_reply_before' => '',
		'title_reply_after'  => '',
		'label_submit'       => __( 'Publish', 'bfcommons-theme' ),
	);
	...
	if ( have_comments() ) : ?>
		...
		if ( ! comments_open() ) : ?>
			<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'bfcommons-theme' ); ?></p><?php
		endif;
